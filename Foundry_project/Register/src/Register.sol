...
contract Register {
    ...
    mapping(address => uint256) ERCbalance;
    mapping(uint16 => uint256) schoolFee;
    mapping(uint16 => uint256) staffSalary;
    ...
    function ExpelStudent(address _address) public {
        require(!IsRegistered[_address], "Student already registered");
